...
from config import config_classifier2 as config_classifier
# from classifier_net import get_model
from classifier_lstm import get_model
...
parser.add_argument('--negative_ratio', default=2, type=int, help='negative : positive')
parser.add_argument('--flip', default=True, type=bool, help='data augmentation flip')
parser.add_argument('--ifswap', default=False, type=bool, help='data augmentation flip')
parser.add_argument('--crop_size', default=64, type=int, help='crop size')
parser.add_argument('--input_channel', default=2, type=int, help='crop size')
...
parser.add_argument('--save_freq', default=10, type=int, metavar='S',help='save frequency')
parser.add_argument('--save_dir', default='', type=str, metavar='SAVE',help='directory to save checkpoint (default: none)')

parser.add_argument('--resume', default=None, type=str, metavar='PATH',help='path to latest checkpoint (default: none)') #sgd
# parser.add_argument('--resume', default='', type=str, metavar='PATH',help='path to latest checkpoint (default: none)') #sgd
parser.add_argument('--jit', action='store_true')

parser.add_argument('--train_mode', default="train", type=str, help='train or test')

parser.add_argument('--preprocess_path_train', default="/ssd/datasets/Lung/20200919_fpn_big_sync_Loss_comb13_ignoreneg_dropout0.0_main_mvd18356_baseline_36_64_mosaic1_lcggn_max-pos_nodules_nospacingnorm",type=str, help="train data preprocessed path")
parser.add_argument('--preprocess_path_valid', default="/ssd/datasets/Lung/20200919_fpn_big_sync_Loss_comb13_ignoreneg_dropout0.0_main_mvd18356_baseline_36_64_mosaic1_lcggn_max-pos_nodules_nospacingnorm",type=str, help="validate data preprocessed path")
parser.add_argument('--train_splite_txt_path',    default="/ssd/datasets/Lung/20200919_fpn_big_sync_Loss_comb13_ignoreneg_dropout0.0_main_mvd18356_baseline_36_64_mosaic1_lcggn_max-pos_nodules_nospacingnorm/train_all_cls_conf_withothers_all2.txt",type=str, help="train splite txt")
parser.add_argument('--validate_splite_txt_path', default="/ssd/datasets/Lung/20200919_fpn_big_sync_Loss_comb13_ignoreneg_dropout0.0_main_mvd18356_baseline_36_64_mosaic1_lcggn_max-pos_nodules_nospacingnorm/train_all_cls_conf_withothers_all2.txt",type=str, help="valid splite txt")

parser.add_argument('--preprocess_path_test', default="/ssd/datasets/Lung/20200711_fpn_big_sync_Loss_comb13_l1loss2_dropout0.0_main_mvd-all_seg_TwoClass_test/091_nodules",type=str, help="train data preprocessed path")
parser.add_argument('--test_splite_txt_path',    default="/ssd/datasets/Lung/20200711_fpn_big_sync_Loss_comb13_l1loss2_dropout0.0_main_mvd-all_seg_TwoClass_test/091_nodules/val_all_cls.txt",type=str, help="train splite txt")
...
def main():
    ...
    if args.jit:
        load_and_save_net_model.netio_trace(net, args)
        sys.exit()
    ...
    if args.train_mode == "train":
        ...
        val_loader = DataLoader( val_dataset, batch_size=16, shuffle=False,num_workers=4, pin_memory=True, drop_last=True)
    ...
    if args.train_mode == "train":
        ...
        trainer.do_test2(args, val_loader, save_dir, start_epoch)
